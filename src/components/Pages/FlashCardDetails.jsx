...
const featureData = [
    {
        ...
        subTitle: "The Pediatric Department provides vaccinations to help protect children from a range of illnesses and diseases, including measles.",
        iconUrl: "/images/departments/icon_9.svg",
    },
    {
        title: "Management of acute illnesses",
        subTitle: "The Pediatric Department provides treatment for common childhood illnesses, such as ear infections, strep throat, and viral infections.",
        iconUrl: "/images/departments/icon_10.svg",
    },
    {
        title: "Treatment of chronic conditions",
        subTitle: "The Pediatric Department provides ongoing care and treatment for children with chronic conditions such as asthma, diabetes, and allergies.",
        iconUrl: "/images/departments/icon_11.svg",
    },
    {
        title: "Developmental screenings",
        subTitle: "The Pediatric Department provides regular developmental screenings to identify any delays or concerns and provide early intervention services.",
...
const doctorData = [
    {
        ...
        description: "With experience in managing complex <br />medical conditions in children",
        social: [
