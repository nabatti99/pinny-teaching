            ...
            <div className="cs_doctors_heading">
                ...
                <div className="cs_view_box">
                    ...
                    <div className="cs_view_box_in">
                        <button type="button" className={`cs_grid_view ${view === "grid" ? "active" : ""}`} onClick={() => setView("grid")}>
                        ...
                        <button type="button" className={`cs_list_view ${view === "list" ? "active" : ""}`} onClick={() => setView("list")}>
                            <svg width={25} height={25} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
