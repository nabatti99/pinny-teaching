...
export default function Header({ logoSrc, variant }) {
    ...
    return (
        <>
            <header className={`cs_site_header cs_style1 cs_sticky_header ${mobileToggle ? "cs_mobile_toggle_active" : ""} ${variant} ${isSticky ? "cs_active_sticky" : ""}`}>
                        ...
                        <div className="cs_main_header_in">
                            <div className="cs_main_header_left">
                                ...
                                <nav className="cs_nav">
                                    <ul className={`${mobileToggle ? "cs_nav_list cs_active" : "cs_nav_list"}`}>
                                        ...
                                        <li className="menu-item-has-children">
                                            ...
                                            <DropDown>
                                                <ul>
                                                    <li>
                                                        <Link to="/games?type=game-1">Game-1</Link>
                                                    </li>
                                                    <li>
                                                        <Link to="/games?type=game-2">Game-2</Link>
                                                    </li>
                                                </ul>
                                            </DropDown>
                                        </li>
                                        <li>
                                            <Link to="/games">Flash Cards</Link>
                                        </li>
                                        <li>
                                    ...
                                    <span className={mobileToggle ? "cs_menu_toggle cs_teggle_active" : "cs_menu_toggle"} onClick={() => setMobileToggle(!mobileToggle)}>
                                        <span></span>
                                    </span>
                                </nav>
                            </div>
                            <div className="cs_main_header_right">
                                <div className="cs_toolbox">
                                    <button className="cs_toolbox_btn cs_search_toggle_btn" type="button" onClick={() => setSearchToggle(!searchToggle)}>
