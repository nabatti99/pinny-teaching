    ...
    return (
        <footer className="cs_footer cs_style_2 cs_type_1 cs_accent_bg cs_white_color">
            <div className="container">
                <NewsletterStyle4 title="Be Our Subscribers" subTitle="Join our newsletter to keep up to date <br />health from our experts" />
            ...
            <div className="cs_footer_bottom">
                <div className="container">
                    <div className="cs_copyright">Copyright © 2023 Pro Health. All rights reserved.</div>
                </div>
            </div>
        </footer>
    );
